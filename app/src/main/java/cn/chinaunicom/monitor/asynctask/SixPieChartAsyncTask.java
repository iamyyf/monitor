...
public class SixPieChartAsyncTask extends AsyncTask<Void, Void, PieChartResp> {
    private SixPieChartViewHolder viewHolder;
    private ChartReq pieChartReq;
    private PieChartsHelper pieChartsHelper;
    private Context context;
    private String param1;

    public SixPieChartAsyncTask(Context context, SixPieChartViewHolder viewHolder, ChartReq req) {
