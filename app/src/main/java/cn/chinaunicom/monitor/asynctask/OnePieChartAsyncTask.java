...
public class OnePieChartAsyncTask extends AsyncTask<Void, Void, PieChartResp> {
    private OnePieChartViewHolder viewHolder;
    private ChartReq pieChartReq;
    private PieChartsHelper pieChartsHelper;
    private Context context;
    private String param1;

    public OnePieChartAsyncTask(Context context, OnePieChartViewHolder viewHolder, ChartReq req) {
