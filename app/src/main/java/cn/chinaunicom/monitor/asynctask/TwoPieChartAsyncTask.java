...
public class TwoPieChartAsyncTask extends AsyncTask<Void, Void, PieChartResp> {
    private TwoPieChartViewHolder viewHolder;
    private ChartReq pieChartReq;
    private PieChartsHelper pieChartsHelper;
    private Context context;
    private String param1;

    public TwoPieChartAsyncTask(Context context, TwoPieChartViewHolder viewHolder, ChartReq req) {
