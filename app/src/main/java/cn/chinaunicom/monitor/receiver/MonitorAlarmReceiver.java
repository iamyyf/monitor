        ...
        try {
            ...
            if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
                ...
                if(MainActivity.instance == null) {
                    //打开自定义的Activity
                    Intent notifiIntent = new Intent(context, LoginActivity.class);
                    notifiIntent.putExtras(bundle);
                    notifiIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    notifiIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    context.startActivity(notifiIntent);
                }
